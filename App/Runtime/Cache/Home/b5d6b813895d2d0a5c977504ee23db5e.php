...
<div class="content">
	...
	<div class="info">
		<script type="text/javascript" src="//qzonestyle.gtimg.cn/qzone/hybrid/app/404/search_children.js" charset="utf-8" homePageUrl="<?php echo 'http://'.$_SERVER['HTTP_HOST'];?>" homePageName="返回网站首页"></script>
	</div>
...
<div class="copyright">
<p><a title="官方网站" href="http://www.xyhcms.com">XYHCMS</a> [ <?php echo date('Y-m-d H:i:s')?> ]</p>
</div>
